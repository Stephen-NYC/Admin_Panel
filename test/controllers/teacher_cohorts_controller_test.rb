...
class TeacherCohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher_cohort" do
    assert_difference('TeacherCohort.count') do
      post teacher_cohorts_url, params: { teacher_cohort: { student_id: @teacher_cohort.student_id, teacher_id: @teacher_cohort.teacher_id } }
    end
  ...
  test "should update teacher_cohort" do
    patch teacher_cohort_url(@teacher_cohort), params: { teacher_cohort: { student_id: @teacher_cohort.student_id, teacher_id: @teacher_cohort.teacher_id } }
